...
const Home = () => {
  ...
  return (
    ...
    <>
      <main id="home" data-spy="scroll" data-target=".navbar-nav" data-offset="80">
        {/* <!-- */}
        {/* Start Preloader */}
        {/* ==================================== --> */}
        <div class="preloader">
        ...
        <section class="section about-2 padding-0 bg-dark" id="about">
          <div class="container-fluid p-0">
            <div class="row no-gutters align-items-center">
              <div class="col-lg-6">
                <img class="img-fluid" src="images/about/about-business-man.jpg" alt="" />
              </div>
              <div class="col-lg-6">
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 text-center">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis tenetur odio impedit incidunt? 
                  <br/> Omnis accusantium ea reiciendis, fugit commodi nostrum.</p>
        ...
        s            <footer id="footer" class="bg-one">
          <div class="container">
